...
app.layout = html.Div(
    [
        html.Div(
                        ...
                        html.Div(
                            [
                                html.Div(
                                    [
                                        html.H2(
                                            children='Suicide Analysis Dashboard (DV Project)',
                                            style={
                                                'fontSize': 24,
                                                'textAlign': 'center'
                                            }
            ...
            style={'marginTop': '5px','backgroundColor': '#f2f2f2', 'padding': '20px'},
            className='row'
        ),        
        html.Div(
            [ 
                html.Div(dcc.RangeSlider(
                       ...
                       style={'width': '1000px',
                              'text-align': 'center', 'margin': 'auto','margin-top' : '30px'},
